...
create table profile{
	...
	create table adress{
		...
		fk_country int not null;#fk for country
		fk_government_district int not null; #fk depending on country
		fk_city int not null;#fk depending on government district
		#constrants
		PRIMARY KEY (adress_id);
		FOREIGN KEY (fk_profile_id) REFERENCES profile(profile_id);
		FOREIGN KEY (fk_country) REFERENCES country(country_id);
		FOREIGN KEY (fk_government_id) REFERENCES profile(profile_id);
		FOREIGN KEY (fk_city) REFERENCES city(city_id);
	}
	...
	create table grade{
		...
		create table profile_grade{
		    ...
		    #Constrants
			PRIMARY KEY (grade_id,profile_id);
			FOREIGN KEY (fk_profile_id) REFERENCES profile(profile_id);
	...
	create table idiom{
		...
		create table profile_idiom{
			...
			FOREIGN KEY (fk_profile_id) REFERENCES profile(profile_id);
			FOREIGN KEY (fk_idiom_id) REFERENCES idiom(fk_idiom_id);
		}
