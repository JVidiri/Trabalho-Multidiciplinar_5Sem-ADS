...
insert into grade values (01, 666, 'Ensino Fundamental incompleto', 1, 55);
insert into grade values (02, 666, 'Pós graduação completa', 50, 55);# 'Pós graduação' is 50 times more important than 'Ensino Fundamental'
